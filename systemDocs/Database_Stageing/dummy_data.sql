...
TRUNCATE TABLE `phase_template_external`;
TRUNCATE TABLE `phase_template_reviewer`;
...
-- 5. Rubric Folder, Templates, and Deliverables
INSERT INTO `rubric_folders` (`id`, `name`, `parent_id`, `created_by`, `created_at`, `updated_at`) VALUES
(1, 'Phase 1', NULL, 2, NOW(), NOW());

INSERT INTO `rubric_templates` (`id`, `name`, `version`, `parent_template_id`, `rubric_folder_id`, `total_marks`, `is_locked`, `created_by`, `created_at`, `updated_at`) VALUES
(1, 'Phase 1 - Proposal (Reviewer)', 1, NULL, 1, 10.00, 1, 2, NOW(), NOW()),
(2, 'Phase 1 - Review I (Reviewer)', 1, NULL, 1, 20.00, 1, 2, NOW(), NOW()),
(3, 'Phase 1 - Final (Reviewer)', 1, NULL, 1, 30.00, 1, 2, NOW(), NOW());

INSERT INTO `deliverables` (`id`, `rubric_template_id`, `title`, `max_marks`, `sort_order`, `created_at`, `updated_at`) VALUES
(1, 1, 'Proposal Review', 10.00, 1, NOW(), NOW()),
(2, 3, 'Final Review', 30.00, 1, NOW(), NOW());
...
INSERT INTO `criteria` (`id`, `title`, `description`, `max_score`, `is_individual`, `rubric_template_id`, `deliverable_id`, `sort_order`, `created_at`, `updated_at`) VALUES
(1, 'Score & Problem Identification', 'Objectives and scope are clearly mentioned.', 2.00, 0, 1, 1, 1, NOW(), NOW()),
(2, 'Technology & Innovation', 'Latest technologies and highly innovative ideas used.', 2.00, 0, 1, 1, 2, NOW(), NOW()),
(6, 'Final Outcome / Prototype', 'Literature study and Technical Analysis requirements.', 5.00, 0, 3, 2, 1, NOW(), NOW()),
(7, 'Report', 'Structure, Comments, Formatting, and Citations.', 5.00, 0, 3, 2, 2, NOW(), NOW()),
(8, 'Project Design', 'Methodologies, Low and High Level Project Design.', 10.00, 0, 3, 2, 3, NOW(), NOW()),

-- THESE ARE INDIVIDUAL SCORES:
(9, 'Presentation', 'Oral presentation communicated effectively within time limit.', 5.00, 1, 3, 2, 4, NOW(), NOW()),
(10, 'Individual Contribution and Viva', 'Demonstration of program capabilities and ability to defend answers.', 5.00, 1, 3, 2, 5, NOW(), NOW());
...
INSERT INTO `phase_template_reviewer` (`id`, `phase_template_id`, `user_id`, `created_at`, `updated_at`) VALUES
(1, 1, 5, NOW(), NOW()),
(2, 1, 6, NOW(), NOW());
...
INSERT INTO `projects` (`id`, `semester_id`, `course_id`, `phase_template_id`, `specialization_id`, `title`, `supervisor_id`, `coordinator_id`, `status`, `created_at`, `updated_at`) VALUES
(1, 1, 1, 1, 1, 'AI-Based Assessment System', 3, 2, 'evaluating', NOW(), NOW()),
(2, 1, 1, 1, 2, 'Smart Campus Network Infrastructure', 4, 2, 'setup', NOW(), NOW());
...
INSERT INTO `evaluations` (`id`, `project_id`, `rubric_template_id`, `evaluator_id`, `evaluator_role`, `fill_order`, `status`, `general_feedback`, `created_at`, `updated_at`) VALUES
(1, 1, 3, 5, 'Reviewer', 3, 'submitted', 'A stellar prototype and excellent research. Well done.', NOW(), NOW()),
(2, 1, 3, 6, 'Reviewer', 3, 'draft', 'Still calculating the presentation scores...', NOW(), NOW());
